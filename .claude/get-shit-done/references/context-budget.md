...
The keys live in `.claude/settings.json` (project) or `/home/seven/data/coding/projects/seven/agent-team-advisor/.claude/settings.json` (global) — **not** in `.planning/config.json`:
