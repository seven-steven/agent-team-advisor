...
```
Agent(
  prompt="Read /home/seven/data/coding/projects/seven/agent-team-advisor/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/seven/data/coding/projects/seven/agent-team-advisor/.claude/get-shit-done/templates/VALIDATION.md`
