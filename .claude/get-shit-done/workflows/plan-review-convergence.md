...
```bash
INIT=$(node "/home/seven/data/coding/projects/seven/agent-team-advisor/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/home/seven/data/coding/projects/seven/agent-team-advisor/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/home/seven/data/coding/projects/seven/agent-team-advisor/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
