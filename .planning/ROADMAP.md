...
- [x] 05-01-PLAN.md — Implement append-only raw audit and task/session correlated views.

**Wave 2** _(blocked on Wave 1 audit helper)_

- [x] 05-02-PLAN.md — Enforce advisor call, token, and latency budgets by task/session scope with degraded audit mode.

**Wave 3** _(blocked on Wave 1 audit helper and Wave 2 budget state)_

- [x] 05-03-PLAN.md — Add layered enforce, warning-only, disabled, and degraded recovery controls while preserving mandatory gates.

**Wave 4** _(blocked on Waves 1-3 operational primitives)_

- [x] 05-04-PLAN.md — Provide read-only doctor validation for hooks, routes, advisor permissions, runtime paths, budget policy, and recovery mode.
...
| 5. Audit, Budget, and Operator Recovery      | 5/8 | In Progress|  |
